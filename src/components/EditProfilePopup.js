...
function EditProfilePopup(props) {
  ...
  return (
      ...
      placeholder="Имя" required minLength="2" maxLength="40" name = "name" onChange={handleNameUpdate}></input>
      ...
      required minLength="2" maxLength="200" id="profile__input_about" onChange={handleDescription}></input>
