...
function handleSubmit(e) {
  ...
  return (
    ...
    >
      <input ref = {inputName} className="popup__field popup__field_name" id="cardName" type="text" name = "name"
      placeholder="Название"  required minLength="1" maxLength="30"></input>
      <span className="popup__span-error" id="cardName-error"></span>
      <input ref = {inputLink} className="popup__field popup__field_about" id="cardUrl" type="url"
